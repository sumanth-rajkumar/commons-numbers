...
/**
 * This is an abstract class that defines all the common data and operations for a ComplexList.
 */
public abstract class ComplexList extends AbstractList<Complex> {
    ...
    /**
     * This class is an extension of ComplexList. It is a resizable-double array implementation of the List interface.
     * Implements all optional list operations, and permits all complex numbers. In addition to implementing the List interface,
     * this class provides methods to manipulate the size of the array that is used internally to store the list.
     *
     * <p>Each ComplexInterleavedList instance has a capacity. The capacity is half the size of the double array used to store the
     * complex numbers in the list. As complex numbers are added to an ComplexList, its capacity grows automatically.
